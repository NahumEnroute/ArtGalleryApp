  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested artwork" do
        artwork = Artwork.create! valid_attributes
        patch artwork_url(artwork), params: { artwork: new_attributes }
        artwork.reload
      ...
      it "redirects to the artwork" do
        ...
        patch artwork_url(artwork), params: { artwork: new_attributes }
        artwork.reload
        expect(response).to redirect_to(artwork_url(artwork))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        artwork = Artwork.create! valid_attributes
        patch artwork_url(artwork), params: { artwork: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
